  ...
  <header class="glass-panel sticky top-0 z-40 flex justify-between items-center h-16 px-8 ml-64 w-[calc(100%-16rem)] border-b border-white/5 text-sm font-medium">
    ...
    <div class="flex items-center gap-6">
      <div class="flex items-center gap-4 text-slate-400">
        <!-- Dark mode toggle -->
        <button class="hover:text-white transition-colors active:opacity-80" @click="toggle">
        ...
        <!-- Notifications -->
        <button class="relative hover:text-white transition-colors active:opacity-80">
